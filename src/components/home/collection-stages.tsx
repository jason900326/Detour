      ...
      {stage === 'passport' && (
        <View style={styles.v41PassportScreen}>
          <View style={styles.v41PassportTop}>
            <Pressable onPress={goBack} hitSlop={16} style={styles.v41PassportBack}>
              <Text style={styles.v41PassportBackText}>←</Text>
            </Pressable>
          ...
          <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.v41PassportScroll}>
            ...
            <View style={styles.v41PassportStats}>
              <View style={styles.v41PassportStat}>
                <Text style={styles.v41PassportStatValue}>{passport.length}</Text>
                <Text style={styles.v41PassportStatLabel}>趟旅程</Text>
              </View>
              <View style={styles.v41PassportStat}>
                <Text style={styles.v41PassportStatValue}>{(totalDistanceMeters / 1000).toFixed(1)}</Text>
                <Text style={styles.v41PassportStatLabel}>公里</Text>
              </View>
              <View style={styles.v41PassportStat}>
                <Text style={styles.v41PassportStatValue}>{totalDiscoveries}</Text>
                <Text style={styles.v41PassportStatLabel}>個發現</Text>
              </View>
            </View>
                ...
                {passport.map((entry, index) => {
                  ...
                  return (
                    <Pressable
                      ...
                      style={({ pressed }) => [styles.v41PassportCard, pressed && styles.v35Pressed]}
                    >
                      {coverUri ? (
                      ...
                      <View style={styles.v41PassportCardBody}>
                        ...
                        <Text style={styles.v41PassportCardDestination} numberOfLines={2}>
                        ...
                        <View style={styles.v41PassportOpen}>
                          <Text style={styles.v41PassportOpenText}>打開這趟</Text>
                          <Text style={styles.v41PassportOpenArrow}>→</Text>
                        </View>
                      </View>
                    </Pressable>
                  );
            ...
            {developerToolsUnlocked && passport.length > 0 && (
              <Pressable
                ...
                style={({ pressed }) => [styles.v41PassportClear, pressed && styles.pressedLight]}
              >
