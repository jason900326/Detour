...
export const legacyStyles = StyleSheet.create({
  ...
  v35JourneyBottom: { flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 6 },
  v35JourneyCamera: { flex: 1, minHeight: 64, borderRadius: 16, backgroundColor: SIGNAL, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10 },
  v35JourneyCameraIcon: { fontSize: 21, color: INK },
  v35JourneyCameraText: { fontSize: 18, fontWeight: '900', color: INK },
  v35JourneyCameraArrow: { marginLeft: 3, fontSize: 25, fontWeight: '800', color: INK },
  v35JourneyAlbum: { width: 64, height: 64, borderRadius: 14, overflow: 'hidden', borderWidth: 2, borderColor: BONE, backgroundColor: '#22211F', position: 'relative' },
  ...
  v35DevAdvance: { position: 'absolute', right: 0, bottom: 94, paddingHorizontal: 12, paddingVertical: 7, backgroundColor: '#2A2926', borderRadius: 13 },
