...
export const legacyStyles = StyleSheet.create({
  ...
  v35JourneyAlbumGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  v35JourneyAlbumGridImage: { width: '31.8%', aspectRatio: 1, borderRadius: 10, backgroundColor: '#2A2926' },
  v35JourneyAlbumGridEmpty: { width: '31.8%', aspectRatio: 1, borderRadius: 10, backgroundColor: '#242321', borderWidth: 1, borderColor: '#302F2B' },
