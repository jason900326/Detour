...
export const legacyStyles = StyleSheet.create({
  ...
  v35JourneyHero: { flex: 1, alignItems: 'center', paddingTop: 20, paddingBottom: 20 },
  ...
  v35JourneyCamera: { flex: 1, minHeight: 62, borderRadius: 18, backgroundColor: SIGNAL, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 12 },
  v35JourneyCameraIcon: { fontSize: 21, color: INK },
  v35JourneyCameraText: { fontSize: 19, fontWeight: '900', color: INK },
  v35JourneyCameraArrow: { marginLeft: 3, fontSize: 25, fontWeight: '800', color: INK },
  v35JourneyAlbum: { width: 62, height: 62, borderRadius: 16, overflow: 'hidden', borderWidth: 2, borderColor: BONE, backgroundColor: '#22211F', position: 'relative' },
