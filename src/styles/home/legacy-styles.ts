...
export const legacyStyles = StyleSheet.create({
  ...
  v35JourneyScreen: { flex: 1, backgroundColor: '#090909', paddingTop: 52, paddingHorizontal: 20, paddingBottom: 22 },
  ...
  v35JourneyBrand: { marginLeft: 10, fontSize: 22, lineHeight: 27, fontWeight: '900', letterSpacing: 3.2, color: BONE },
  ...
  v35JourneyHero: { flex: 1, alignItems: 'center', paddingTop: 16, paddingBottom: 16 },
  ...
  v35JourneyTimer: { marginLeft: 'auto', fontSize: 20, lineHeight: 25, fontWeight: '900', letterSpacing: 0.4, color: BONE },
  v35JourneyElapsed: { marginBottom: 16, fontSize: 14, lineHeight: 20, fontWeight: '800', letterSpacing: 0.5, color: '#A9A59C' },
  ...
  v35JourneyInstruction: { marginTop: 0, fontSize: 28, lineHeight: 35, fontWeight: '900', letterSpacing: -1, color: BONE },
  v35JourneyInstructionDistance: {
    marginTop: 7,
    fontSize: 14,
    lineHeight: 19,
    fontWeight: '700',
  ...
  v50CompassCalm: { width: 176, height: 176, borderRadius: 88, borderWidth: 13 },
  v50CompassAttention: { width: 176, height: 176, borderRadius: 88, borderWidth: 13 },
  v50CompassArrowCalm: { fontSize: 102, lineHeight: 112 },
  v50CompassArrowAttention: { fontSize: 102, lineHeight: 112 },
  v50JourneyDistanceCalm: { marginTop: 16, fontSize: 25, lineHeight: 31, fontWeight: '800', letterSpacing: -0.4, color: BONE },
  v50JourneyDistanceAttention: { marginTop: 18, fontSize: 42, lineHeight: 49, letterSpacing: -1.5 },
  v50JourneyInstructionCalm: { marginTop: 6, fontSize: 16, lineHeight: 22, fontWeight: '700', letterSpacing: -0.2, color: '#B7B2A8' },
  v50JourneyInstructionAttention: { marginTop: 8, fontSize: 22, lineHeight: 29, letterSpacing: -0.8 },
  v35JourneySideEventWrap: { width: '100%', marginBottom: 18, alignItems: 'center' },
  v35JourneyInstructionBlock: {
    width: '100%',
    minHeight: 116,
    paddingHorizontal: 18,
    paddingVertical: 16,
  ...
  v35JourneyInstructionCopy: { flex: 1 },
  v35JourneyInstructionEyebrow: {
    marginBottom: 8,
    fontSize: 10,
    fontWeight: '800',
    letterSpacing: 2,
  ...
  v35JourneyColorDot: { width: 12, height: 12, borderRadius: 6 },
  v35JourneyColorText: { flex: 1, color: BONE, fontSize: 15, fontWeight: '800' },
  v35JourneyStatus: { marginTop: 12, fontSize: 12, color: '#A29E95' },
  v35JourneyMapWrap: { width: '100%', height: 235, marginBottom: 22, borderRadius: 22, overflow: 'hidden', borderWidth: 1, borderColor: '#2B2B2B', backgroundColor: '#151515' },
  v35JourneyMapPlaceholder: { width: '100%', height: 235, marginBottom: 22, borderRadius: 22, backgroundColor: '#151515' },
  ...
  v35JourneyBottom: { flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 10 },
  v35JourneyCamera: { flex: 1, minHeight: 68, paddingHorizontal: 16, borderRadius: 16, backgroundColor: SIGNAL, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 10 },
  v35JourneyCameraIcon: { fontSize: 21, color: INK },
  v35JourneyCameraCopy: { alignItems: 'flex-start' },
  v35JourneyCameraEyebrow: { marginBottom: 2, fontSize: 9, fontWeight: '800', letterSpacing: 1.2, color: 'rgba(17,17,15,0.66)' },
  v35JourneyCameraText: { fontSize: 19, lineHeight: 23, fontWeight: '900', color: INK },
  v35JourneyCameraArrow: { marginLeft: 3, fontSize: 25, fontWeight: '800', color: INK },
  v35JourneyAlbum: { width: 68, height: 68, borderRadius: 14, overflow: 'hidden', borderWidth: 2, borderColor: BONE, backgroundColor: '#22211F', position: 'relative' },
  v35JourneyAlbumPressed: { opacity: 0.72, transform: [{ scale: 0.96 }] },
  v35JourneyAlbumImage: { width: '100%', height: '100%' },
  v35JourneyAlbumLabel: { position: 'absolute', left: 5, bottom: 5, paddingHorizontal: 5, paddingVertical: 3, borderRadius: 7, backgroundColor: 'rgba(9,9,9,0.78)' },
  v35JourneyAlbumLabelText: { fontSize: 9, fontWeight: '800', color: BONE },
  ...
  v35JourneyAlbumMeta: { marginTop: 3, fontSize: 12, fontWeight: '700', color: '#A9A59C' },
  v35JourneyAlbumClose: { width: 38, height: 38, borderRadius: 19, backgroundColor: '#302F2B', alignItems: 'center', justifyContent: 'center' },
  v35JourneyAlbumCloseText: { fontSize: 27, lineHeight: 28, color: BONE },
  v35JourneyAlbumGrid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between' },
  v35JourneyAlbumGridCell: {
    width: '31%',
    height: 96,
    marginBottom: 8,
    borderRadius: 10,
  ...
  v35JourneyAlbumGridImage: { width: '100%', height: '100%' },
  v35JourneyAlbumGridEmpty: {
    backgroundColor: '#242321',
    borderWidth: 1,
    borderColor: '#302F2B',
  },
  v35JourneyAlbumGridPressed: { opacity: 0.7 },
  v35JourneyPhotoPreviewOverlay: {
    flex: 1,
  ...
  v35JourneyPhotoPreviewImage: {
    width: '100%',
    height: 460,
    borderRadius: 16,
    backgroundColor: '#0D0D0C',
  },
  v35JourneyPhotoPreviewFooter: {
    paddingHorizontal: 4,
    paddingTop: 12,
  },
  v35JourneyPhotoPreviewTitle: {
    fontSize: 16,
    lineHeight: 21,
    fontWeight: '800',
    color: BONE,
  },
  v35JourneyPhotoPreviewMeta: {
    marginTop: 4,
    fontSize: 11,
    color: '#A9A59C',
  },
  v35JourneyPhotoPreviewClose: {
    position: 'absolute',
    top: 20,
    right: 20,
    width: 38,
  ...
  v35JourneyPhotoPreviewCloseText: {
    fontSize: 27,
    lineHeight: 28,
    color: BONE,
  },
  ...
  v35DevAdvance: { minHeight: 42, marginTop: 10, paddingHorizontal: 13, borderWidth: 1, borderRadius: 12, borderColor: '#3A3833', backgroundColor: '#141413', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  v35DevAdvanceCopy: { flexDirection: 'row', alignItems: 'center', gap: 9 },
  v35DevAdvanceEyebrow: { fontSize: 9, fontWeight: '800', letterSpacing: 1.2, color: SIGNAL },
  v35DevAdvanceText: { fontSize: 11, fontWeight: '700', color: '#A9A59B' },
  v35DevAdvanceArrow: { fontSize: 18, color: SIGNAL },
  v52RecoveryScreen: { flex: 1, backgroundColor: '#F5F1E8', paddingTop: 58, paddingHorizontal: 24, paddingBottom: 30, justifyContent: 'space-between' },
  v52RecoveryTop: { minHeight: 58, flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between' },
  v52RecoveryBrand: { fontSize: 24, fontWeight: '900', letterSpacing: 4.2, color: INK },
  v52RecoveryEyebrow: { paddingTop: 5, fontSize: 14, fontWeight: '900', color: SIGNAL },
  v52RecoveryHero: { flex: 1, justifyContent: 'center' },
  v52RecoveryTitle: { fontSize: 42, lineHeight: 49, fontWeight: '900', letterSpacing: -2.2, color: INK },
  v52RecoveryBody: { marginTop: 18, fontSize: 17, lineHeight: 27, fontWeight: '600', color: '#706C64' },
  v52RecoveryFacts: { marginTop: 32, paddingVertical: 18, borderTopWidth: 1, borderBottomWidth: 1, borderColor: '#D2CBC0', flexDirection: 'row' },
  v52RecoveryFact: { flex: 1 },
  v52RecoveryFactLabel: { fontSize: 13, fontWeight: '800', color: MUTED },
  v52RecoveryFactValue: { marginTop: 7, fontSize: 20, fontWeight: '900', color: INK },
  v52RecoveryPhoto: { width: 112, height: 112, marginTop: 24, borderRadius: 14, backgroundColor: SOFT },
  v52RecoveryActions: { gap: 12 },
  v52RecoveryContinue: { minHeight: 68, paddingHorizontal: 20, backgroundColor: INK, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  v52RecoveryContinueText: { fontSize: 20, fontWeight: '900', color: BONE },
  v52RecoveryContinueArrow: { fontSize: 28, color: SIGNAL },
  v52RecoveryDiscard: { minHeight: 48, alignItems: 'center', justifyContent: 'center' },
  v52RecoveryDiscardText: { fontSize: 15, fontWeight: '800', color: '#706C64' },
  v52RecoveryDisabled: { opacity: 0.56 },
